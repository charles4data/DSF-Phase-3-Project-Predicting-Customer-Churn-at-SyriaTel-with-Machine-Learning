...
![](images/random_kfold.png "Random Forest with k-fold cross-validation results")
...
![](images/random_n.png "Random Forest with reduced n_estimators and limited max_depth results")


![](images/confusion_matrix.png "Random Forest confusion matrix")


![](images/feature_importance.png "The top 10 most important features of the random  forest model")



![](images/comparison_frame.png "Selecting The Best Model")
...
![](images/roc_curves.png "ROC Curves")
